...
})({"lzLN5":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "038e6ead7d0005e9";
...
},{}],"5TpCn":[function(require,module,exports) {
// GLOBAL SCRIPT
...
if (loginForm) loginForm.addEventListener("submit", function(e) {
    ...
    (0, _sendRequest.sendAjaxRequest)({
        method: "POST",
        url: "/api/auth/login",
        body: {
            username,
...
if (clientSignupForm) clientSignupForm.addEventListener("submit", function(e) {
    e.preventDefault();
    signupUser.call(this, "/api/auth/signup", "client/add/address");
});
const companySignupForm = document.getElementById("companySignupForm");
if (companySignupForm) companySignupForm.addEventListener("submit", function(e) {
    e.preventDefault();
...
if (addAddressForm) addAddressForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
...
if (addMaterialForm) addMaterialForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
...
if (submitOrderForm) submitOrderForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    ...
    if (!(paper || metal || plastic || glass || electric)) {
        (0, _alert.showDangerAlert)("Please Select One Material.");
        return false;
    } else if (!address) {
        (0, _alert.showDangerAlert)("Please Select Address.");
        return false;
    }
    (0, _sendRequest.sendAjaxRequest)({
        method: "POST",
...
if (cashMoneyForm) cashMoneyForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    const creditCard = form.get("card");
    const money = form.get("money");
    if (!Number(creditCard) || creditCard.length < 16) (0, _alert.showDangerAlert)("Invalid Credit Card.");
    if (!Number(money)) (0, _alert.showDangerAlert)("Invalid Cash.");
    (0, _sendRequest.sendAjaxRequest)({
...
if (addAgentForm) addAgentForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
...
if (usersSection) usersSection.addEventListener("click", function(e) {
    e.preventDefault();
...
if (userProfileForm) userProfileForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    const username = form.get("username");
    const firstname = form.get("firstname");
...
if (changePasswordForm) changePasswordForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
...
if (editAddressForm) editAddressForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    ...
    (0, _sendRequest.sendAjaxRequest)({
        method: "PATCH",
        url: user === "client" ? `/api/client/address/${address}` : `/api/agent/address`,
        body: {
            ...addressFields
        },
...
if (addressesSection) addressesSection.addEventListener("click", function(e) {
...
if (editMaterialForm) editMaterialForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    const materialsFields = getMaterialsFormFields(form);
...
if (materialsSection) materialsSection.addEventListener("click", function(e) {
...
if (deliverOrderForm) deliverOrderForm.addEventListener("submit", function(e) {
    e.preventDefault();
    const form = new FormData(this);
    const paper = form.get("paper");
    const metal = form.get("metal");
    ...
    for (const type of Object.keys(materials))if (materials[type]) {
        if (!Number(materials[type])) {
            (0, _alert.showDangerAlert)(`${type[0].toUpperCase() + type.slice(1)} invalid value: ${materials[type]}.`);
            return false;
        } else materials[type] = Number(materials[type]);
    } else delete materials[type];
...
if (deleteOrderBtn) deleteOrderBtn.addEventListener("click", function(e) {
    e.preventDefault();
    const { order  } = this.dataset;
    (0, _sendRequest.sendAjaxRequest)({
        method: "DELETE",
...
},{"./alert":"bDRv1","./sendRequest":"hPm9g"}],"bDRv1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showSuccessAlert", ()=>showSuccessAlert);
parcelHelpers.export(exports, "showDangerAlert", ()=>showDangerAlert);
...
const showDangerAlert = (message, top)=>{
    const alert = createAlert(message);
...
},{}],"hPm9g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendAjaxRequest", ()=>sendAjaxRequest);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const sendAjaxRequest = async function({ method , url , success_message , body ={} , redirect_url ="/" ,  }) {
    try {
        ...
        if (data.status !== "success") {
            ...
            (0, _alert.showDangerAlert)(data.message);
            return;
        }
        (0, _alert.showSuccessAlert)(success_message);
        setTimeout(()=>{
        ...
        console.log(err);
        const { data: data1  } = err.response;
        if (data1.status === "fail" || data1.status === "error") {
            if (typeof data1.message === "string") {
                (0, _alert.showDangerAlert)(data1.message);
                return;
            }
            data1.message.forEach((msg, i)=>(0, _alert.showDangerAlert)(msg, (i + 1) * 7));
        }
    }
};

},{"axios":"jo6P5","./alert":"bDRv1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}]},["lzLN5","5TpCn"], "5TpCn", "parcelRequire7444")
